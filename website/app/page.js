...
const TRANSLATIONS = {
  en: {
    ...
    badge: "Version v1.0.8 Now Available",
  ...
  fr: {
    ...
    badge: "Version v1.0.8 Disponible",
    ...
    <div className={styles.container} data-theme={theme}>
      ...
      <section id="downloads" className={styles.middleDownloads}>
        ...
        <div className={styles.downloadGrid}>
          {/* Windows */}
          <a href="https://github.com/Volgat/cobrabub/releases/download/v1.0.8/CobraBub-Setup-1.0.8.exe" className={styles.downloadOption}>
