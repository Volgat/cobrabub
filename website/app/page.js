...
const TRANSLATIONS = {
  en: {
    ...
    badge: "Version v1.0.9 Now Available",
  ...
  fr: {
    ...
    badge: "Version v1.0.9 Disponible",
    ...
    <div className={styles.container} data-theme={theme}>
      ...
      <section id="downloads" className={styles.middleDownloads}>
        ...
        <div className={styles.downloadGrid}>
          {/* Windows */}
          <a href="https://github.com/Volgat/cobrabub/releases/download/v1.0.9/CobraBub-Setup-1.0.9.exe" className={styles.downloadOption}>
